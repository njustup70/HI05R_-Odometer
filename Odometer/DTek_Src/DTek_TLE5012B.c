...
/* ʹ�� CMSIS �ٷ��꣬����ȫ�ҿ�ϵ�м����Ը��� */
#define GPIO_MODER_INPUT   0x00000000u   // 00: ����ģʽ (����ж�ȡ���������)
#define GPIO_MODER_ANALOG  0x00000003u   // 11: ģ��ģʽ (������̬��������ͣ��Ƽ�����)
#define GPIO_MODER_AF      0x00000002u   // 10: ����ģʽ

/* PA7 ��ƫ���� */
#define REGISTER_OFFSET    (7U * 2U)     

/* * ��̬�л� PA7 ģʽ 
 * ����ֱ��ʹ�ùٷ��ṩ�� GPIO_MODER_MODER7 (�� 0x3 << 14)
 * �������л�Ϊģ��ģʽ (Analog) ��Ϊ���ŵĸ���̬����
 */
