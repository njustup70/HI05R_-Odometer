...
/* 使用 CMSIS 官方宏，更安全且跨系列兼容性更好 */
#define GPIO_MODER_INPUT   0x00000000u   // 00: 输入模式 (如果有读取需求用这个)
#define GPIO_MODER_ANALOG  0x00000003u   // 11: 模拟模式 (纯高阻态，功耗最低，推荐此项)
#define GPIO_MODER_AF      0x00000002u   // 10: 复用模式

/* PA7 的偏移量 */
#define REGISTER_OFFSET    (7U * 2U)     

/* * 动态切换 PA7 模式 
 * 掩码直接使用官方提供的 GPIO_MODER_MODER7 (即 0x3 << 14)
 * 这里以切换为模拟模式 (Analog) 作为最优的高阻态方案
 */
